...
public class Attack implements Node,ChildK {
	...
	public Attack(Type type, OpponentPolicy oP) {
		super();
		this.type = type;
		OP = oP;
	}
	...
	public String translate() {
		...
		return "attack("+this.type.translate()+","+this.OP.translate()+")";
	}
	...
	public String getName() {
		// TODO Auto-generated method stub
		return "Attack_Type_OpponentPolicy";
	}
        ...
        Player p = gs.getPlayer(player);
		 ...
		 for(Unit u:pgs.getUnits()) {
			...
			// if(u.getType()==UTType)System.out.println("d");
	            if (  u.getPlayer() == player && u.getType().name.equals(this.type.getValue()) && gs.getActionAssignment(u) == null && automato.getAbstractAction(u)==null) {
