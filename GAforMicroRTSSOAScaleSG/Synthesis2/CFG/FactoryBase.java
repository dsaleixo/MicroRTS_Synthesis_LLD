...
public class FactoryBase implements Factory {
	...
	@Override
	public Build build_Build(Type type, Direction direc) {
		// TODO Auto-generated method stub
		return new Build(type,direc);
	}
	...
	@Override
	public Train build_Train(Type type, Direction direc) {
		// TODO Auto-generated method stub
		return new Train(type,direc);
	}
