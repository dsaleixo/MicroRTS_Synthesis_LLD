...
public class CabocoDagua implements EvaluateGS {
	...
	public CabocoDagua(List<GameState> gss,int play) {
		// TODO Auto-generated constructor stub
...
double pont= 0.0;
		...
		pont +=0.5* (1 - diffType(this.worker,oraculo.worker));
