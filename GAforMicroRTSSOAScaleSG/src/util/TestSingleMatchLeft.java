...
public class TestSingleMatchLeft extends Thread {
    ...
    public TestSingleMatchLeft(iDSL sIA1, AI sIA2, GameState gs, PhysicalGameState pgs, UnitTypeTable utt, String message) {
        this.sIA1 = sIA1;
        this.sIA2 = sIA2;
