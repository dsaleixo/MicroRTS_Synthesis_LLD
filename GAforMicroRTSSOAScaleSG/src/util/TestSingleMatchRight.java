...
public class TestSingleMatchRight extends Thread {
    ...
    public TestSingleMatchRight(AI sIA1, iDSL sIA2, GameState gs, PhysicalGameState pgs, UnitTypeTable utt, String message) {
        this.sIA1 = sIA1;
        this.sIA2 = sIA2;
