...
public class TestSinglePlayout extends Thread {
    ...
    public TestSinglePlayout(iDSL sIA1, iDSL sIA2, GameState gs, PhysicalGameState pgs, UnitTypeTable utt) {
        this.sIA1 = sIA1;
        this.sIA2 = sIA2;
...
//        JFrame w = PhysicalGameStatePanel.newVisualizer(gs,640,640,false,PhysicalGameStatePanel.COLORSCHEME_WHITE);        
        ...
        //System.out.println("printing current state "+gs2);
...
//        this.allCommandIA2.addAll(((DslAI) ai2).getCommands());        
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(TestSinglePlayout.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
